...
export default function ExperienceSection() {
  const experiences = [
    ...
    },
    {
      ...
      description: [
        "Create interactive eLearning modules with scenario-based design",
        "Apply instructional models (ADDIE, SAM) to reduce design cycles by 25%",
        "Manage SAP Litmos LMS for 500+ users; tracked engagement metrics",
        "Publish support articles in Shelf",
        "Collaborate with project managers to align content with KPIs and optimize training ROI",
      ],
    ...
    },
    {
      ...
      description: [
        "Develop microlearning content using Synthesia, Canva, and Evolve",
        "Improve retention by 15% through interactive learning design",
        "Present learning designs to senior leadership and led needs assessments",
        "Design interactive VILT and WBT programs tailored to diverse learner groups",
      ],
    ...
    },
     {
      ...
      company: "TTEC, Philippines",
      description: [
        "Develop microlearning content using Synthesia, Canva, and 7taps, improving retention by 15%.",
        "Present learning designs to senior leadership and led needs assessments for global projects.",
        "Design interactive VILT and WBT programs tailored to diverse learner groups.",
      ],
      icon: <Code className="text-gray-400" size={24} />,
      current: false,
    },
    {
      ...
      description: [
        "Redesign onboarding programs with SMEs, boosting new hire satisfaction from 70% to 88%",
        "Produce video-based training using Vyond and Camtasia; accelerated learning completion by 25%",
        "Lead evaluations using Kirkpatrick Model and managed LMS platforms (Cornerstone, Axonify)",
      ],
      icon: <Award className="text-gray-400" size={24} />,
      current: false,
    },
